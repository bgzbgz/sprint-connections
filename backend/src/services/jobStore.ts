...
import { Job, JobStatus, FileType, jobToResponse, JobResponse } from '../models/job';
  ...
  const exampleJobs: Job[] = [
    {
      ...
      qa_report: {
        score: 94,
        passed_checks: ['Brand compliance', 'Mobile responsive', 'Input validation', 'Clear scoring', 'Multi-step flow'],
        failed_checks: [],
        recommendations: ['Consider adding team size input'],
        notes: 'Excellent hiring decision calculator with clear scoring framework'
      },
    ...
    },
    {
      ...
      qa_report: {
        score: 91,
        passed_checks: ['Brand compliance', 'Mobile responsive', 'Clear calculations', 'Investment analysis'],
        failed_checks: [],
        recommendations: ['Consider adding chart visualization'],
        notes: 'Clean ROI calculator with clear investment metrics'
      },
