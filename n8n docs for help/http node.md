# **HTTP Request node[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#http-request-node)**
...
There are two ways to create an HTTP request: configure the [node parameters](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#node-parameters) or [import a curl command](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#import-curl-command).
...
## **Node parameters[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#node-parameters)**

### **Method[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#method)**
...
### **URL[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#url)**

Enter the endpoint you want to use.

### **Authentication[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#authentication)**
...
#### **Predefined credentials[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#predefined-credentials)**
...
#### **Generic credentials[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#generic-credentials)**
...
### **Send Query Parameters[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#send-query-parameters)**
...
### **Send Headers[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#send-headers)**
...
### **Send Body[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#send-body)**
...
#### **Form URLencoded[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#form-urlencoded)**
...
#### **Form-Data[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#form-data)**
...
#### **JSON[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#json)**
...
#### **n8n Binary File[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#n8n-binary-file)**
...
#### **Raw[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#raw)**
...
## **Node options[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#node-options)**

Select **Add Option** to view and select these options. Options are available to all parameters unless otherwise noted.

### **Array Format in Query Parameters[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#array-format-in-query-parameters)**
...
### **Batching[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#batching)**
...
### **Ignore SSL Issues[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#ignore-ssl-issues)**
...
### **Lowercase Headers[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#lowercase-headers)**

Choose whether to lowercase header names (turned on, default) or not (turned off).

### **Redirects[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#redirects)**
...
### **Response[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#response)**
...
### **Pagination[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#pagination)**
...
### **Proxy[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#proxy)**

Use this option if you need to specify an HTTP proxy.

Enter the **Proxy** the request should use. This takes precedence over global settings defined with the [HTTP\_PROXY, HTTPS\_PROXY, or ALL\_PROXY environment variables](https://docs.n8n.io/hosting/configuration/environment-variables/deployment/).

### **Timeout[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#timeout)**
...
## **Tool-only options[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#tool-only-options)**
...
### **Optimize Response[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#optimize-response)**
...
#### **JSON[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#json_1)**
...
#### **HTML[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#html)**
...
#### **Text[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#text)**
...
## **Import curl command[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#import-curl-command)**
...
## **Templates and examples[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/#templates-and-examples)**
