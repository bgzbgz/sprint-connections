# **Execute Sub-workflow[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.executeworkflow/#execute-sub-workflow)**

Use the Execute Sub-workflow node to run a different workflow on the host machine that runs n8n.

## **Node parameters[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.executeworkflow/#node-parameters)**

### **Source[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.executeworkflow/#source)**
...
### **Workflow Inputs[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.executeworkflow/#workflow-inputs)**
...
### **Mode[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.executeworkflow/#mode)**
...
## **Node options[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.executeworkflow/#node-options)**
...
## **Templates and examples[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.executeworkflow/#templates-and-examples)**
...
## **Set up and use a sub-workflow[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.executeworkflow/#set-up-and-use-a-sub-workflow)**

This section walks through setting up both the parent workflow and sub-workflow.

### **Create the sub-workflow[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.executeworkflow/#create-the-sub-workflow)**

1. Create a new workflow.  
2. **Create sub-workflows from existing workflows**  
3. You can optionally create a sub-workflow directly from an existing parent workflow using the [Execute Sub-workflow](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.executeworkflow/) node. In the node, select the **Database** and **From list** options and select **Create a sub-workflow** in the list.  
4. You can also extract selected nodes directly using [Sub-workflow conversion](https://docs.n8n.io/workflows/subworkflow-conversion/) in the context menu.  
5. **Optional**: configure which workflows can call the sub-workflow:  
   * Select the **Options** ![Options menu][image1] menu \> **Settings**. n8n opens the **Workflow settings** modal.  
   * Change the **This workflow can be called by** setting. Refer to [Workflow settings](https://docs.n8n.io/workflows/settings/) for more information on configuring your workflows.  
6. Add the **Execute Sub-workflow** trigger node (if you are searching under trigger nodes, this is also titled **When Executed by Another Workflow**).  
7. Set the **Input data mode** to choose how you will define the sub-workflow's input data:  
...
8. Add other nodes as needed to build your sub-workflow functionality.  
9. Save the sub-workflow.
...
### **Call the sub-workflow[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.executeworkflow/#call-the-sub-workflow)**
...
6. Fill in the required input items defined by the sub-workflow.  
...
## **How data passes between workflows[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.executeworkflow/#how-data-passes-between-workflows)**
...
[image1]: <data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAsAAAAXCAYAAADduLXGAAAAbklEQVR4XmP4/efff2IxA7oAPjwYFR8+cvT/5ClTwRjExqu4v3/C/9DQUDAGsfEqzszKgisGsfEqXr5iJVwxiI1XMSGMYXJhYREYEzS5vr4B7gwQm3qKSXIGIYxhMtFBR1KkkBTdJCUkQniQKAYA4JmhJgPWXgEAAAAASUVORK5CYII=>