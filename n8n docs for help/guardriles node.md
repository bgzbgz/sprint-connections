# **Guardrails node[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-langchain.guardrails/#guardrails-node)**
...
## **Node parameters[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-langchain.guardrails/#node-parameters)**

Use these parameters to configure the Guardrails node.

### **Operation[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-langchain.guardrails/#operation)**
...
### **Text To Check[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-langchain.guardrails/#text-to-check)**
...
### **Guardrails[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-langchain.guardrails/#guardrails)**
...
* **PII:** Detects personally identifiable information (PII) in the text.  
  ...
  * **Entities**: (Appears if **Type** is **Selected**) A multi-select list of PII types to detect (for example, CREDIT\_CARD, EMAIL\_ADDRESS, PHONE\_NUMBER, and US\_SSN).  
...
### **Customize System Message[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-langchain.guardrails/#customize-system-message)**
