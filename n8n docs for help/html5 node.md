# **HTML[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.html/#html)**
...
## **Operations[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.html/#operations)**

* [**Generate HTML template**](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.html/#generate-html-template): Use this operation to create an HTML template. This allows you to take data from your workflow and output it as HTML.  
* [**Extract HTML content**](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.html/#extract-html-content): Extract contents from an HTML-formatted source. The source can be in JSON or a binary file (.html).  
* [**Convert to HTML Table**](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.html/#convert-to-html-table): Convert content to an HTML table.
...
## **Generate HTML template[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.html/#generate-html-template)**
...
## **Extract HTML Content[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.html/#extract-html-content)**

Extract contents from an HTML-formatted source. The source can be in JSON or a binary file (.html).

Use these parameters:

### **Source Data[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.html/#source-data)**
...
### **Extraction Values[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.html/#extraction-values)**
...
### **Extract HTML Content options[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.html/#extract-html-content-options)**
...
## **Convert to HTML Table[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.html/#convert-to-html-table)**
...
## **Templates and examples[\#](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.html/#templates-and-examples)**
